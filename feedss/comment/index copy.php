        ...
        <div class="flex-grow-1">
            ...
            <div class="small ms-2 mt-1">
                <a href="javascript:;"
                   ...
                   <span id="like-comes-<?= $value['comment_id'] ?>"><?= $value['like_count'] ?></span> .Like
                </a>
                <a href="javascript:;"
                   onclick="replyTo(<?= $value['feed_id'] ?>,'<?= $comments['status'] ?>','<?= $value['comment_id'] ?>','<?= $value['comment_id'] ?>','<?= $comment_data_comms['first_name'].'-'.$comment_data_comms['last_name']; ?>','<?= $comment_data_comms['username'] ?>')"
                   class="text-secondary fw-bold text-decoration-none me-3">
                   <span><?= $value['reply_count'] ?></span> .Reply
                </a>
                        ...
                        <div class="flex-grow-1">
                            <div class="comment-bubble py-1 px-3">
                                <div class="fw-bold small">
                                    <a href="#"><?= $comment_data_replies['username'] ?></a>
                                    <i class="ri-play-fill"></i>
                                    <a href="#"><?= $comment_data_replies['last_name'] ?></a>
                                </div>
            ...
            <?php if ($value['reply_count'] > 3): ?>
                <div class="reply-thread">
                    <a href="javascript:;" 
                       onclick="loadMoreReplies(<?= $value['feed_id'] ?>, <?= $value['comment_id'] ?>)" 
                       class="ms-5 text-decoration-none">
                       --------- see more (<?= $value['reply_count'] ?>) -----------
                    </a>
                </div>
            <?php endif; ?>
        </div>
