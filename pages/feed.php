                        ...
                        <div class="container my-3 d-flex px-0">
                            ...
                            <div class="col-lg-3 d-lg-none d-none" id='container_RTL'>
                                <span data-href="/profile?u=<?= $fetch_user_info['id'] ?>" class="sidebar-link">
                                    <img src="/uploads/<?= $profile['profile_pic'] ?>" class="rounded-circle me-3" width="36" height="36" style="object-fit: cover;">
                                    <span><?= $profile['username'] ?></span>
                                </span>
                                <?php
                                   $sideBarNavMenu=[
                                    ['friends','ri-group-fill','#2833ac'],
                                    ['memories','ri-history-line', '#0dcaf0'],
                                    ['saved','ri-bookmark-fill', '#a855f7'],
                                    ['pages','ri-flag-fill','#f97316'],
                                    ['events','ri-calendar-event-fill','#801d31']
                                    ];
                                    foreach($sideBarNavMenu as $menu):
                                    ?>
                                    <span  data-href="<?= $menu[0] ?>" class="p-2 d-block p-2">
                                    <i class="<?= $menu[1] ?> fs-5" style="color:<?= $menu[2] ?>"></i> <?= $menu[0] ?></span>
                                <?php endforeach; ?>
                                <hr>
                                <h6 class="px-2 text-secondary">Shortcuts</h6>
                                <?php
                                   $sideBarNavMenu=[
                                    ['Gaming Hub','ri-gamepad-fill', '']
                                    ];
                                    foreach($sideBarNavMenu as $menu):
                                ?>
                                <span data-href="<?= $menu[0] ?>" class="py-2"><i class="<?= $menu[1] ?>" ></i> <?= $menu[0] ?></span>
                                <?php endforeach; ?>
                            </div>
                            ...
                            <div style="width: 100%; max-width: 590px;" id="feeds-main-update-div">
                                ...
                                <div class="container px-0">
                                    <div id="reelifield" class="d-flex gap-3 pb-3 overflow-auto" style="scrollbar-width: none; -ms-overflow-style: none;">
                                        <span data-href="create-reels"  class="card text-decoration-none bg-white border-0 shadow-sm flex-shrink-0" style="width: 130px; border-radius: 15px; overflow: hidden;">
                                        ...
                                        <?php foreach($fetch_reels as $reels):
                                            $profile_reel=json_decode($reels['profile'],true);
                                            $datas_reel=json_decode($reels['data'],true);
                                        ?>
                                            <span data-href="reels?u=<?= $reels['feed_id'] ?>" class="position-relative flex-shrink-0 shadow-sm user-reel" style="width: 130px; height: 210px; border-radius: 15px; overflow: hidden;">
                                                <div class="h-100 w-100" style="background: url('/uploads/reel_covers/<?= $datas_reel['cover'] ?>) center/cover;"></div>
                                                <div class="position-absolute top-0 start-0 w-100 h-100 d-flex flex-column justify-content-between p-2" 
                                                    ...
                                                    <div class="avatar-ring">
                                                        <img src="/uploads/<?= $profile_reel['profile_pic'] ?>" class="rounded-circle border border-2 border-primary" width="35" height="35">
                                                    </div>
                                                    <div class="blur-footer rounded-2 py-1 px-2">
                                                        <div class="text-white small fw-semibold text-truncate" style="font-size: 0.75rem;"><?= $profile_reel['username'] ?></div>
                                                    </div>
                                                </div>
                                            </span>
                                        <?php endforeach ?>
                                ...
                                <div class="mb-3 bg-white rounded-3">
                                    <div class="d-flex align-items-center p-2">
                                        <span data-href="profile?u=<?= $fetch_user_info['id'] ?>"><img src="/uploads/<?= $profile['profile_pic'] ?>" class="rounded-circle me-2" width="40" height="40" style="object-fit: cover;" /></span>
                          ...
                          <div class="col-lg-3 d-none d-lg-none" id="container_LTR">
