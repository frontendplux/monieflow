...
function generateUniqueAccountNumber($conn) {
    do {
        $accNo = '30' . sprintf('%08d', random_int(0, 99999999));
...
function createOrGetWallet($conn, $uid) {
    $stmt = $conn->prepare("SELECT public_id, private_key, account_number, balance FROM wallets WHERE uid = ?");
...
<body>
    ...
    <main class="container py-4 px-3">
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4 gap-3">
            ...
            <div>
                <a href="/member/voucher.php" class="btn btn-skyblue rounded-3 px-4 py-2 w-100 w-md-auto">
                    <i class="bi bi-plus-lg me-1"></i> Generate Recharge voucher
                </a>
            </div>
        </div>
        ...
        <div class="row g-4 mb-4">
            ...
            <div class="col-12 col-lg-8">
                <div class="row g-2 g-sm-3">
                    ...
                    <div class="col-3 col-sm-4 col-md-3">
                        <a href="/member/wallet.php" class="action-card p-2 p-sm-3 text-center d-block">
                            <div class="icon-box mb-2"><i class="bi bi-wallet text-warning"></i></div>
                            <span class="fw-semibold text-truncate d-block" style="font-size: 0.75rem;">Wallet</span>
                        </a>
                    </div>
                    <div class="col-3 col-sm-4 col-md-3">
