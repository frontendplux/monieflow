            ...
            <div class="page-title d-flex">
                ...
                <div class="align-self-center ms-auto">
                    ...
                    class="icon gradient-blue color-white shadow-bg shadow-bg-xs rounded-m">
                        ...
                        <em class="badge bg-red-dark color-white scale-box"><?= count($main->getUnreadNotifications()[2]); ?></em>
                    </a>
                    <a href="#"
                    data-bs-toggle="dropdown"
                    class="icon gradient-blue shadow-bg shadow-bg-s rounded-m">
                        <img src="images/<?= $main->getUserData()['data']['profile']['img'] ?? 'user.png' ?>" width="45px" height="45px" class="rounded-m" alt="img">
                    </a>
