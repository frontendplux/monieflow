...
<head>
    ...
    <style>
        ...
        .btn-boss:hover { transform: scale(1.02); background: #0bb5d8; box-shadow: 0 0 20px rgba(13, 202, 240, 0.4); }
        ...
        <div class="row justify-content-center">
            <div class="col-xl-10 col-lg-11">
                ...
                <div class="text-center mb-5">
                    ...
                    <p class="text-secondary tracking-widest uppercase small">PUBLISH TO THE FLOW STUDIO</p>
                </div>
                            ...
                            <div class="col-lg-5">
                                <div class="mb-4">
                                    ...
                                    <label for="fileInput" class="drop-zone d-flex flex-column align-items-center justify-content-center w-100" id="dropArea">
                                        ...
                                        <p id="fileName" class="text-secondary text-center small px-3 m-0">Drag MP3 here or <span class="text-info">Browse</span></p>
                                ...
                                <div class="p-3 rounded-4 bg-info bg-opacity-10 border border-info border-opacity-25">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            <p class="text-white fw-bold mb-0" style="font-size: 14px;">Premium Distribution</p>
                                            <p class="text-info mb-0" style="font-size: 11px;">you earn when view payments</p>
                                        </div>
                                        <div class="form-check form-switch">
                                            <input class="form-check-input bg-info border-0" type="checkbox" role="switch" id="subToggle" style="cursor: pointer;">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-7">
                                ...
                                <div class="d-flex flex-column flex-md-row gap-4 mb-4 align-items-start align-items-md-center">
                                    <div class="position-relative flex-shrink-0">
                                        <div id="imagePreview" class="rounded-circle border border-2 border-info d-flex align-items-center justify-content-center overflow-hidden bg-dark" 
                                        ...
                                        <label for="coverInput" class="position-absolute bottom-0 end-0 bg-info rounded-circle d-flex align-items-center justify-content-center shadow-sm" 
                                               style="width: 32px; height: 32px; border: 3px solid #141414; cursor: pointer;">
                                    ...
                                    <div class="flex-grow-1 w-100">
                                        <label class="text-secondary small fw-bold mb-1">SONG TITLE</label>
                                        <input type="text" id="trackTitle" class="form-control rounded-3" placeholder="e.g. Turbulence (Refix)" required>
                                    </div>
                                </div>

                                <div class="mb-4">
                                    <label class="text-secondary small fw-bold mb-1">DESCRIPTION</label>
                                    <textarea class="form-control rounded-3" rows="2" placeholder="Tell the world about this vibe..."></textarea>
                                </div>

                                <div class="row g-3 mb-4">
                                    <div class="col-6">
                                        <label class="text-secondary small fw-bold mb-1">HASHTAGS</label>
                                        <input type="text" class="form-control rounded-3" placeholder="#Asake #Boss">
                                    </div>
                                    <div class="col-6">
                                        <label class="text-secondary small fw-bold mb-1">CATEGORY</label>
                                ...
                                <div id="progressWrapper" class="mb-4 d-none">
                                    <div class="d-flex justify-content-between mb-1">
                                        <span class="small text-info">Uploading to Cloud...</span>
                                ...
                                <div class="text-center mt-3">
                                    <a href="studio.html" class="text-secondary text-decoration-none small hover-text-info">Back to Studio</a>
                                </div>
                            </div>
    ...
    <script>
        ...
        coverInput.onchange = (e) => {
            ...
            if (file) {
                ...
                imagePreview.innerHTML = `<img src="${url}" class="w-100 h-100" style="object-fit: cover;">`;
            }
        };
        ...
        fileInput.onchange = (e) => {
            if(e.target.files.length > 0) {
                fileNameLabel.innerHTML = `<i class="ri-check-double-line text-info"></i><br>Selected: <span class="text-white">${e.target.files[0].name}</span>`;
            }
        };
...
form.onsubmit = async (e) => {
    ...
    formData.append("hashtags", document.querySelectorAll("input")[2].value);
