...
function showTransferAlert(message = "Transfer Successful!", type = "success", duration = 2500) {
    // Remove existing alert if any
    const existing = document.getElementById("transferAlertOverlay");
    if (existing) existing.remove();

    // Choose image and color based on type
    const imgUrl = type === "success"
        ? "https://cdn-icons-png.flaticon.com/512/190/190411.png" // green check
        : type === "error"
        ? "https://cdn-icons-png.flaticon.com/512/1828/1828665.png" // red cross
        : "https://cdn-icons-png.flaticon.com/512/565/565547.png"; // info icon

    const bgColor = type === "success" ? "#e6f8ed" : type === "error" ? "#fdecea" : "#e6f0fa";

    // Create overlay
    const overlay = document.createElement("div");
    overlay.id = "transferAlertOverlay";
...
function showAlertX(type, message, timeout = 4000) {
